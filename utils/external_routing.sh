...
ifconfig wlxe84e065d4aff 10.1.1.120 netmask 255.255.255.0
ifconfig enp2s0f1 10.1.11.115 netmask 255.255.255.0

#ip addr add 10.1.1.120/24 dev wlx801f02697156
...
ip route add 10.2.11.115 dev wlxe84e065d4aff
arp -i wlxe84e065d4aff -s 10.2.11.115 80:ce:62:2a:b1:e5 # enp2s0f1's mac address
