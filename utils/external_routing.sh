...
ifconfig wlx801f02697156 10.1.1.120 netmask 255.255.255.0
...
ip route add 10.2.11.115 dev wlx801f02697156
arp -i wlx801f02697156 -s 10.2.11.115 80:ce:62:2a:b1:e5 # enp2s0f1's mac address
