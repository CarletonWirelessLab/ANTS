...
def control_sg(setup_file, on_file, off_file, on_percent = 0.2, \
               seed=None, initial_delay=0, run_duration=10.0, cycle_duration = 4.3, \
    ...
    on_time = cycle_duration * on_percent
    ...
    # and a duty cycle defined by the input parameters cycle_duration and
    # on_percent, respectively. This includes an optional initial delay
    # which can be added to every cycle if it is desired
...
if __name__ == '__main__':
    control_sg("awgn_setup.txt", "awgn_on.txt", "awgn_off.txt", run_duration=20.0, test_mode=True, on_percent=0.01)
